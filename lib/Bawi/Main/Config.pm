...
sub init {
    ...
    my $main_dir_arg = $arg{-main_dir} ? $arg{-main_dir} : 'main';
    my $main_dir = File::Spec->catdir($ENV{BAWI_PERL_HOME}, $main_dir_arg);
    my $skin_dir = File::Spec->catdir($main_dir, 'skin');
